...
export class C64Mapper {
    ...
    public convertScreenram(pixelImage: PixelImage,
        ...
        return this.extractAttributeData(pixelImage, yOffset, (x, y) => {
            ...
            return ((pixelImage.colorMaps[upperColorIndex].get(x, y) << 4) & 0xf0)
    ...
    private extractAttributeData(pixelImage: PixelImage, yOffset: number,
                                 callback: (x: number, y: number) => number): Uint8Array {
