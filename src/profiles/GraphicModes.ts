...
export default class GraphicModes {
  ...
  public static c64Multicolor: GraphicMode = ((): GraphicMode => {
  ...
  public static c64MulticolorFake: GraphicMode = ((): GraphicMode => {
    const result: GraphicMode = new GraphicMode(160, 200, Palettes.peptoPalette, function () {
      const pixelImage: PixelImage = new PixelImage(this);
  ...
  public static c64Hires: GraphicMode = new GraphicMode(320, 200, Palettes.peptoPalette, function () {
    const pixelImage: PixelImage = new PixelImage(this);
  ...
  // C64 resolution and palette, but no attribute restrictions (not supported on real c64)
  public static c64HiresFake: GraphicMode = new GraphicMode(320, 200, Palettes.peptoPalette, function () {
    const pixelImage: PixelImage = new PixelImage(this);
    pixelImage.addColorMap(1, 1);
    return pixelImage;
  });
  ...
  public static c64HiresMono: GraphicMode = new GraphicMode(320, 200, Palettes.peptoPalette, function () {
    const pixelImage: PixelImage = new PixelImage(this);
    pixelImage.addColorMap();
    pixelImage.addColorMap();
    return pixelImage;
  ...
  // C64 FLI mode
  public static c64FLI: GraphicMode = ((): GraphicMode => {
    const result: GraphicMode = new GraphicMode(160, 200, Palettes.peptoPalette, function () {
      const pixelImage: PixelImage = new PixelImage(this);
      pixelImage.addColorMap();
      pixelImage.addColorMap(4, 8);
  ...
  // C64 AFLI mode
  public static c64AFLI: GraphicMode = ((): GraphicMode => {
